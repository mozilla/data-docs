...
- **October 23 2019** - [Hot-fix shipped through add-ons](https://docs.google.com/document/d/1gQF-iU3E21SG985Cl2Ius4LoRXduUrNa5In9hafLIqs/edit) that reset the Telemetry endpoint preference back to the default for a large number of users.
