...
In the context of [Glean](#glean), a metric refers to an instrumented measure for a specific aspect of the product (similar to a [probe](#probe) in the context of Firefox).
