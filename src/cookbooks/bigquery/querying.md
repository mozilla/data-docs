...
- Each or our tables is exposed by a view in the mozdata project, which in some cases it applies filters or business definitions. As a best practice and whenever possible, query the view instead of querying directly the underlying table(s) directly.
