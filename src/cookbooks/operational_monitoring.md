...
The definitions files are platform-specific and located in the `definitions/` directory of [opmon-config](https://github.com/mozilla/opmon-config). Platform-specific configuration files follow the same format as project configuration files.
