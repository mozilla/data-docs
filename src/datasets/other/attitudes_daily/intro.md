The `attitudes_daily` table is a Telemetry instantiation of user reponses to the [Daily Attitudes Survey (DAS)](https://qsurvey.mozilla.com/collab/daily-attitude-survey) over time. 
