The `attitudes_daily` table is a Telemetry instantiation of user responses to the [Daily Attitudes Survey (DAS)](BROKEN:https://qsurvey.mozilla.com/collab/daily-attitude-survey) over time.
