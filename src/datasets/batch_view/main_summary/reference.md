...
[Main Summary file][main_summary_code].
...
please look
[in the `MainSummaryView` code][main_summary_code].
...
[telemetry-batch-view][main_summary_code].
Refer to this repository for information on how to run or augment the dataset.

[main_summary_code]: https://github.com/mozilla/telemetry-batch-view/blob/master/GRAVEYARD.md#main-summary-clients-daily-and-addons
