...
- If possible, use "you" when describing how to do something. Avoid use of first person (e.g. _I_, _we_, _our_) as this emphasizes the writer rather than the reader and it is often unclear who _I_, _we_ or _our_ actually refer to.
